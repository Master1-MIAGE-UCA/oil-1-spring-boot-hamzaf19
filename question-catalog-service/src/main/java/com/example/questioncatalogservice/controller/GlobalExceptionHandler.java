...
import com.example.questioncatalogservice.service.BadRequestException;
import com.example.questioncatalogservice.service.QuestionNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleNotFound(QuestionNotFoundException exception, HttpServletRequest request) {
    ...
    public ResponseEntity<ApiError> handleBadRequest(Exception exception, HttpServletRequest request) {
        String message = switch (exception) {
            ...
            case DataIntegrityViolationException ignored -> "La requete viole une contrainte de donnees.";
